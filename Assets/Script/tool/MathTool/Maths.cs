...
namespace MathTool
{
    ...
    internal class Math
    {
        ...
        /// 产生随机数
        /// </summary>
        /// <param name="min">最小值，取得到</param>
        /// <param name="max">最大值，取不到</param>
        /// <returns>随机数</returns>
        ...
        /// <summary>
        /// 给一个事件组和要随机发生几件事，返回具体发生哪几件
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="array">事件组</param>
        /// <param name="haoManyThing">要随机发生几件事</param>
        /// <returns>具体发生的几个事件</returns>
